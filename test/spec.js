...
const WEBPACK_VERSIONS = {
//  three: '3.11.0',
  four: '4.1.0',
};
const webpack = {};
for (const [majorVersion, semver] of Object.entries(WEBPACK_VERSIONS)) {
  niv.install(`webpack@${semver}`);
  webpack[majorVersion] = niv.require(`webpack@${semver}`);
}
...
for (const version of Object.keys(webpack)) {
  // describe(`[webpack ${version}] When passed async chunks, it`, function() {
  //   it('should add preload tags', function(done) {
  //     const compiler = webpack[version]({
  //       entry: {
  ...
  // describe(`[webpack ${version}] When passed non-async chunks, it`, function() {
  //   it('should add preload tags', function(done) {
  //     const compiler = webpack[version]({
  ...
  // describe(`[webpack ${version}] When passed normal chunks, it`, function() {
  ...
  describe(`[webpack ${version}] When using an empty config, it`, function() {
    it('should not preload .map files', function(done) {
      const compiler = webpack[version]({
        ...
        console.log(result.compilation);
